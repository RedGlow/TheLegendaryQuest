/*! the-legendary-quest 2015-07-25 */
...
k[d].$destroy(),(l[d]=a.leave(q)).then(n(l,d))}h.length=0,k.length=0,(g=f.cases["!"+c]||f.cases["?"])&&m(g,function(c){c.transclude(function(d,e){k.push(e);var f=c.element;d[d.length++]=U.createComment(" end ngSwitchWhen: "),h.push({clone:d}),a.enter(d,f.parent(),f)})})})}}}],He=Ma({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,c,d,e,f){e.cases["!"+d.ngSwitchWhen]=e.cases["!"+d.ngSwitchWhen]||[],e.cases["!"+d.ngSwitchWhen].push({transclude:f,element:c})}}),Ie=Ma({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,c,d,e,f){e.cases["?"]=e.cases["?"]||[],e.cases["?"].push({transclude:f,element:c})}}),Ke=Ma({restrict:"EAC",link:function(a,c,d,e,f){if(!f)throw J("ngTransclude")("orphan",ua(c));f(function(a){c.empty(),c.append(a)})}}),ke=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(c,d){"text/ng-template"==d.type&&a.put(d.id,c[0].text)}}}],Ag={$setViewValue:v,$render:v},Bg=["$element","$scope","$attrs",function(a,c,d){var e=this,f=new Sa;e.ngModelCtrl=Ag,e.unknownOption=y(U.createElement("option")),e.renderUnknownOption=function(c){c="? "+Ga(c)+" ?",e.unknownOption.val(c),a.prepend(e.unknownOption),a.val(c)},c.$on("$destroy",function(){e.renderUnknownOption=v}),e.removeUnknownOption=function(){e.unknownOption.parent()&&e.unknownOption.remove()},e.readValue=function(){return e.removeUnknownOption(),a.val()},e.writeValue=function(c){e.hasOption(c)?(e.removeUnknownOption(),a.val(c),""===c&&e.emptyOption.prop("selected",!0)):null==c&&e.emptyOption?(e.removeUnknownOption(),a.val("")):e.renderUnknownOption(c)},e.addOption=function(a,c){Ra(a,'"option value"'),""===a&&(e.emptyOption=c);var d=f.get(a)||0;f.put(a,d+1)},e.removeOption=function(a){var c=f.get(a);c&&(1===c?(f.remove(a),""===a&&(e.emptyOption=t)):f.put(a,c-1))},e.hasOption=function(a){return!!f.get(a)}}],le=function(){return{restrict:"E",require:["select","?ngModel"],controller:Bg,link:function(a,c,d,e){var f=e[1];if(f){var g=e[0];if(g.ngModelCtrl=f,f.$render=function(){g.writeValue(f.$viewValue)},c.on("change",function(){a.$apply(function(){f.$setViewValue(g.readValue())})}),d.multiple){g.readValue=function(){var a=[];return m(c.find("option"),function(c){c.selected&&a.push(c.value)}),a},g.writeValue=function(a){var d=new Sa(a);m(c.find("option"),function(a){a.selected=w(d.get(a.value))})};var h,l=NaN;a.$watch(function(){l!==f.$viewValue||ka(h,f.$viewValue)||(h=ia(f.$viewValue),f.$render()),l=f.$viewValue}),f.$isEmpty=function(a){return!a||0===a.length}}}}}},ne=["$interpolate",function(a){function c(a){a[0].hasAttribute("selected")&&(a[0].selected=!0)}return{restrict:"E",priority:100,compile:function(d,e){if(A(e.value)){var f=a(d.text(),!0);f||e.$set("value",d.text())}return function(a,d,e){var k=d.parent(),m=k.data("$selectController")||k.parent().data("$selectController");m&&m.ngModelCtrl&&(f?a.$watch(f,function(a,f){e.$set("value",a),f!==a&&m.removeOption(f),m.addOption(a,d),m.ngModelCtrl.$render(),c(d)}):(m.addOption(e.value,d),m.ngModelCtrl.$render(),c(d)),d.on("$destroy",function(){m.removeOption(e.value),m.ngModelCtrl.$render()}))}}}}],me=ra({restrict:"E",terminal:!1}),Hc=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){e&&(d.required=!0,e.$validators.required=function(a,c){return!d.required||!e.$isEmpty(c)},d.$observe("required",function(){e.$validate()}))}}},Gc=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){if(e){var f,g=d.ngPattern||d.pattern;d.$observe("pattern",function(a){if(L(a)&&0<a.length&&(a=new RegExp("^"+a+"$")),a&&!a.test)throw J("ngPattern")("noregexp",g,a,ua(c));f=a||t,e.$validate()}),e.$validators.pattern=function(a){return e.$isEmpty(a)||A(f)||f.test(a)}}}}},Jc=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){if(e){var f=-1;d.$observe("maxlength",function(a){a=W(a),f=isNaN(a)?-1:a,e.$validate()}),e.$validators.maxlength=function(a,c){return 0>f||e.$isEmpty(c)||c.length<=f}}}}},Ic=function(){return{restrict:"A",require:"?ngModel",link:function(a,c,d,e){if(e){var f=0;d.$observe("minlength",function(a){f=W(a)||0,e.$validate()}),e.$validators.minlength=function(a,c){return e.$isEmpty(c)||c.length>=f}}}}};O.angular.bootstrap?void 0:(ce(),ee(ca),y(U).ready(function(){Zd(U,Ac)}))}(window,document),!window.angular.$$csp()&&window.angular.element(document.head).prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>'),angular.module("supplyCrateApp.gw2api",["supplyCrateApp.now"]).config(["$logProvider",function($logProvider){$logProvider.debugEnabled(!0)}]).provider("GW2API",function(){var provider=this;return provider.itemsEntrySecondsDuration=86400,provider.recipesEntrySecondsDuration=86400,provider.listingsEntrySecondsDuration=60,provider.timeoutDelay=250,provider.language=null,this.$get=function($q,$http,$log,$timeout,Now){function produceRequestsEntry(entrySecondsDuration,endpoint){return{queue:{},queued:{},cache:{},entrySecondsDuration:entrySecondsDuration,timerIsStarted:!1,endpoint:endpoint}}function runRequests(key){var request=requests[key];request.timerIsStarted=!1;for(var queueIds=Object.keys(request.queue),i=0;i<queueIds.length;i++){var id=queueIds[i],deferreds=request.queue[id];request.queued[id]=[],Array.prototype.push.apply(request.queued[id],deferreds)}request.queue={};var ids=queueIds.join(","),url=request.endpoint+"?ids="+ids;provider.language&&(url+="&lang=",url+=provider.language),$http.get(url).then(function(response){var i,item,id,data=response.data,now=Now.value();for(i=0;i<data.length;i++)item=data[i],id=item.id,request.cache[id]={timestamp:now,value:item,isRejection:!1};for(i=0;i<data.length;i++){item=data[i],id=item.id;for(var queueRow=request.queued[id],j=0;j<queueRow.length;j++)queueRow[j].resolve(item),numRunningRequests--;delete request.queued[id];for(var k=0;k<ids.length;k++){var queueId=queueIds[k];if(queueId==id)break}queueIds.splice(k,1)}for(i=0;i<queueIds.length;i++){var queueId=queueIds[i],queueRow=request.queued[queueId],returnValue={text:"all ids provided are invalid"};request.cache[queueId]={timestamp:now,value:returnValue,isRejection:!0};for(var j=0;j<queueRow.length;j++)queueRow[j].reject(returnValue),numRunningRequests--;delete request.queued[queueId]}},function(err){for(var now=Now.value(),i=0;i<queueIds.length;i++){var queueId=queueIds[i],queueRow=request.queued[queueId],returnValue={text:"all ids provided are invalid"};request.cache[queueId]={timestamp:now,value:returnValue,isRejection:!0};for(var j=0;j<queueRow.length;j++)queueRow[j].reject(returnValue),numRunningRequests--;delete request.queued[queueId]}})}function isInt(value){return!isNaN(value)&&parseInt(Number(value))===value&&!isNaN(parseInt(value,10))}function enqueue(key,id){if(!isInt(id))return $q.reject("Not an id:",id);id=parseInt(id);var request=requests[key],cacheEntry=request.cache[id];if(void 0!==cacheEntry){var cacheDate=cacheEntry.timestamp,delta=(Now.value()-cacheDate)/1e3;if(delta<=request.entrySecondsDuration)return cacheEntry.isRejection?$q.reject(cacheEntry.value):$q.when(cacheEntry.value);delete request.cache[id]}var deferred=$q.defer();numRunningRequests++;var queuedEntry=request.queued[id];return void 0!==queuedEntry?queuedEntry.push(deferred):(void 0===request.queue[id]&&(request.queue[id]=[]),request.queue[id].push(deferred),request.timerIsStarted||($timeout(function(){runRequests(key)},provider.timeoutDelay),request.timerIsStarted=!0)),deferred.promise}var numRunningRequests=0,requests={items:produceRequestsEntry(provider.itemsEntrySecondsDuration,"https://api.guildwars2.com/v2/items"),listings:produceRequestsEntry(provider.listingsEntrySecondsDuration,"https://api.guildwars2.com/v2/commerce/listings"),recipes:produceRequestsEntry(provider.recipesEntrySecondsDuration,"https://api.guildwars2.com/v2/recipes")};return{getItem:function(id){return enqueue("items",id)},getListing:function(id){return enqueue("listings",id)},getRecipe:function(id){return enqueue("recipes",id)},getNumRunningRequests:function(){return numRunningRequests}}},this}),angular.module("supplyCrateApp.price-directive",[]).directive("price",function(){return{restrict:"E",scope:{value:"="},templateUrl:"price-directive.html",controller:["$scope",function($scope){$scope.$watch("value",function(){var value=$scope.value,sign=1;0>value&&(sign=-1,value=-value);var copper=value%100;value-=copper,value/=100;var silver=value%100;value-=silver,value/=100;var gold=value;gold>0?gold=sign*gold:silver>0?silver=sign*silver:copper=sign*copper,$scope.copper=copper,$scope.silver=silver,$scope.gold=gold,$scope.hasGold=0!==gold,$scope.hasSilver=0!==gold||0!==silver})}]}}),angular.module("supplyCrateApp.now",[]).factory("Now",function(){return{value:function(){return new Date}}}),angular.module("legendarySearch",["supplyCrateApp.gw2api","supplyCrateApp.price-directive"]).config(["GW2APIProvider",function(GW2APIProvider){GW2APIProvider.language="en"}]).service("RunningRequests",["$q","GW2API",function($q,GW2API){var extra=0;return{get:function(){return GW2API.getNumRunningRequests()+extra},startRequest:function(){extra++},endRequest:function(){extra--},finallyEndRequest:function(reason){extra--}}}]).service("CostComputer",function(){return{recipeItemIds:{19621:9615,19622:9617,19623:9618,19624:9616,19627:9621,19628:9622,19629:9623,19630:9624,19631:9625,19632:9626,19633:9627,19634:9631,19635:9628,19636:9629,19637:9630,19638:9632,19639:9633,19640:9634,19641:9635,19642:9636,19643:9637},costs:{9615:[{type:"currency",id:"copper",amount:1e5}],9616:[{type:"currency",id:"copper",amount:1e5}],9617:[{type:"currency",id:"copper",amount:1e5}],9618:[{type:"currency",id:"copper",amount:1e5}],9621:[{type:"currency",id:"copper",amount:1e5}],9622:[{type:"currency",id:"copper",amount:1e5}],9623:[{type:"currency",id:"copper",amount:1e5}],9624:[{type:"currency",id:"copper",amount:1e5}],9625:[{type:"currency",id:"copper",amount:1e5}],9626:[{type:"currency",id:"copper",amount:1e5}],9627:[{type:"currency",id:"copper",amount:1e5}],9628:[{type:"currency",id:"copper",amount:1e5}],9629:[{type:"currency",id:"copper",amount:1e5}],9630:[{type:"currency",id:"copper",amount:1e5}],9631:[{type:"currency",id:"copper",amount:1e5}],9632:[{type:"currency",id:"copper",amount:1e5}],9633:[{type:"currency",id:"copper",amount:1e5}],9634:[{type:"currency",id:"copper",amount:1e5}],9635:[{type:"currency",id:"copper",amount:1e5}],9636:[{type:"currency",id:"copper",amount:1e5}],9637:[{type:"currency",id:"copper",amount:1e5}],19625:[{type:"item",id:19621,amount:1},{type:"item",id:19624,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24555,amount:1}],19626:[{type:"item",id:19675,amount:77},{type:"item",id:19721,amount:250},{type:"item",id:19673},{type:"item",id:19672}],19644:[{type:"item",id:19622,amount:1},{type:"item",id:19627,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24865,amount:1}],19645:[{type:"item",id:19621,amount:1},{type:"item",id:19634,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24548,amount:1}],19646:[{type:"item",id:19623,amount:1},{type:"item",id:19630,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24607,amount:1}],19647:[{type:"item",id:19621,amount:1},{type:"item",id:19632,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24562,amount:1}],19648:[{type:"item",id:19621,amount:1},{type:"item",id:19631,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24570,amount:1}],19649:[{type:"item",id:19621,amount:1},{type:"item",id:19633,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24584,amount:1}],19650:[{type:"item",id:19621,amount:1},{type:"item",id:19635,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24607,amount:1}],19651:[{type:"item",id:19622,amount:1},{type:"item",id:19635,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24592,amount:1}],19652:[{type:"item",id:19623,amount:1},{type:"item",id:19637,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24554,amount:1}],19653:[{type:"item",id:19621,amount:1},{type:"item",id:19629,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24601,amount:1}],19654:[{type:"item",id:19623,amount:1},{type:"item",id:19638,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24572,amount:1}],19655:[{type:"item",id:19621,amount:1},{type:"item",id:19639,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24554,amount:1}],19656:[{type:"item",id:19622,amount:1},{type:"item",id:19634,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24548,amount:1}],19657:[{type:"item",id:19621,amount:1},{type:"item",id:19641,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24612,amount:1}],19658:[{type:"item",id:19623,amount:1},{type:"item",id:19642,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24632,amount:1}],19659:[{type:"item",id:19622,amount:1},{type:"item",id:19643,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24561,amount:1}],19660:[{type:"item",id:19622,amount:1},{type:"item",id:19628,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24571,amount:1}],19661:[{type:"item",id:19622,amount:1},{type:"item",id:19636,amount:1},{type:"item",id:19676,amount:100},{type:"item",id:24615,amount:1}],19662:[{type:"item",id:19622},{type:"item",id:19640},{type:"item",id:19676,amount:100},{type:"item",id:24618}],19664:[{type:"currency",id:"ascalonian_tear",amount:500}],19665:[{type:"currency",id:"seal_of_beetletun",amount:500}],19666:[{type:"currency",id:"manifesto_of_the_moletariate",amount:500}],19667:[{type:"currency",id:"deadly_bloom",amount:500}],19668:[{type:"currency",id:"flame_legion_charr_carving",amount:500}],19669:[{type:"currency",id:"shard_of_zhaitan",amount:500}],19670:[{type:"currency",id:"symbol_of_koda",amount:500}],19671:[{type:"currency",id:"knowledge_crystal",amount:500}],19672:[{type:"item",id:24357,amount:250},{type:"item",id:24289,amount:250},{type:"item",id:24351,amount:250},{type:"item",id:24358,amount:250}],19673:[{type:"item",id:24295,amount:250},{type:"item",id:24283,amount:250},{type:"item",id:24300,amount:250},{type:"item",id:24277,amount:250}],19674:[{type:"item",id:20797},{type:"item",id:19925,amount:250},{type:"item",id:19677},{type:"item",id:19678}],19676:[{type:"currency",id:"copper",amount:1e4}],19678:[{type:"currency",id:"badge_of_honor",amount:500}],19675:[{type:"item",id:19925,amount:3.3},{type:"item",id:19976,amount:3.3},{type:"item",id:19721,amount:3.3},{type:"item",id:20796,amount:6.6}],19925:[{type:"currency",id:"karma",amount:2100}],20796:[{type:"currency",id:"spirit_shard",amount:.1}],20797:[{type:"currency",id:"spirit_shard",amount:200}],30684:[{type:"item",id:29166},{type:"item",id:19625},{type:"item",id:19626},{type:"item",id:19674}],30685:[{type:"item",id:29172},{type:"item",id:19644},{type:"item",id:19626},{type:"item",id:19674}],30686:[{type:"item",id:29178},{type:"item",id:19660},{type:"item",id:19626},{type:"item",id:19674}],30687:[{type:"item",id:29167},{type:"item",id:19645},{type:"item",id:19626},{type:"item",id:19674}],30688:[{type:"item",id:29168},{type:"item",id:19646},{type:"item",id:19626},{type:"item",id:19674}],30689:[{type:"item",id:30703},{type:"item",id:30704},{type:"item",id:24277,amount:5},{type:"item",id:20796,amount:10}],30693:[{type:"item",id:29174},{type:"item",id:19651},{type:"item",id:19626},{type:"item",id:19674}],30696:[{type:"item",id:29177},{type:"item",id:19653},{type:"item",id:19626},{type:"item",id:19674}],30697:[{type:"item",id:29179},{type:"item",id:19659},{type:"item",id:19626},{type:"item",id:19674}],30702:[{type:"item",id:29184},{type:"item",id:19662},{type:"item",id:19626},{type:"item",id:19674}],30690:[{type:"item",id:29170},{type:"item",id:19649},{type:"item",id:19626},{type:"item",id:19674}],30691:[{type:"item",id:29171},{type:"item",id:19657},{type:"item",id:19626},{type:"item",id:19674}],30692:[{type:"item",id:29173},{type:"item",id:19650},{type:"item",id:19626},{type:"item",id:19674}],30694:[{type:"item",id:29175},{type:"item",id:19661},{type:"item",id:19626},{type:"item",id:19674}],30695:[{type:"item",id:29176},{type:"item",id:19652},{type:"item",id:19626},{type:"item",id:19674}],30698:[{type:"item",id:29180},{type:"item",id:19654},{type:"item",id:19626},{type:"item",id:19674}],30699:[{type:"item",id:29181},{type:"item",id:19655},{type:"item",id:19626},{type:"item",id:19674}],30700:[{type:"item",id:29182},{type:"item",id:19656},{type:"item",id:19626},{type:"item",id:19674}],30701:[{type:"item",id:29183},{type:"item",id:19658},{type:"item",id:19626},{type:"item",id:19674}],30703:[{type:"item",id:29169},{type:"item",id:19647},{type:"item",id:19626},{type:"item",id:19674}],30704:[{type:"item",id:29185},{type:"item",id:19648},{type:"item",id:19626},{type:"item",id:19674}]},legendaryIds:[30702,30698,30699,30686,30696,30697,30684,30687,30690,30685,30701,30691,30695,30688,30692,30694,30693,30700,30703,30704,30689]}}).service("GW2APIFinder",["$q","$http",function($q,$http){var cache={};return{getRecipeFromOutput:function(id){if(cache[id])return $q.when(cache[id]);var url="https://api.guildwars2.com/v2/recipes/search?output="+id;return $http.get(url).then(function(response){return cache[id]=response.data,cache[id]})}}}]).service("RecipeSynthesizer",["$q","GW2API",function($q,GW2API){var brokenItems={9616:"Gift of Ice",9622:"Unicorn Statue",9623:"Gift of History",9624:"Gift of Music",9630:"Gift of Weather",9632:"Gift of Color",9634:"Wolf Statue",9635:"Shark Statue"},baseRecipe={name:"Recipe: ",description:"Synthesized recipe",type:"Consumable",level:0,rarity:"Legendary",vendor_value:12500,game_types:["Dungeon","Pve","Wvw"],flags:["AccountBound","NoSalvage","AccountBindOnUse"],restrictions:[],id:9636,icon:"https://render.guildwars2.com/file/3D423F6758A5265FF1195303529B32E239C6B0BF/849385.png",details:{type:"Unlock",unlock_type:"CraftingRecipe",recipe_id:1715}};return{getItem:function(itemId){var brokenItem=brokenItems[itemId];if(brokenItem){var newItem=jQuery.extend(!0,{},baseRecipe);return newItem.name=newItem.name+brokenItem,$q.when(newItem)}return GW2API.getItem(itemId)}}}]).service("RecipeComputer",["$q","GW2API","GW2APIFinder","CostComputer",function($q,GW2API,GW2APIFinder,CostComputer){return{getRecipe:function(itemId){var recipe=CostComputer.costs[itemId];return recipe?$q.when(recipe):GW2APIFinder.getRecipeFromOutput(itemId).then(function(recipeIds){if(0==recipeIds.length)return $q.reject("No recipe found for itemId = "+itemId);var recipeId=recipeIds[0];return GW2API.getRecipe(recipeId)}).then(function(recipe){var ingredients=recipe.ingredients;if(-1!=jQuery.inArray("LearnedFromItem",recipe.flags||[])){var recipeItemId=CostComputer.recipeItemIds[recipe.output_item_id];if(!recipeItemId)return $q.reject("No recipe item id registered for output item id = "+recipe.output_item_id);ingredients=ingredients.slice(0),ingredients.push({item_id:recipeItemId,count:1})}return jQuery.map(ingredients,function(entry){return{type:"item",id:entry.item_id,amount:entry.count}})})}}}]).service("BankService",["$q","$http","RunningRequests",function($q,$http,RunningRequests){return{getFullBankContent:function(apiKey){function addResults(response){var data=response.data?response.data:response;jQuery.each(data,function(i,entry){null!==entry&&(idToAmount[entry.id]||(idToAmount[entry.id]=0),idToAmount[entry.id]+=entry.count)})}var idToAmount={},errors={inventories:!1,characters:!1};return RunningRequests.startRequest(),$http.get("https://api.guildwars2.com/v2/tokeninfo?access_token="+apiKey).then(function(response){RunningRequests.endRequest();var tokenInfo=response.data,promises=[];if(-1!=jQuery.inArray("inventories",tokenInfo.permissions)){RunningRequests.startRequest();var bankContent=$http.get("https://api.guildwars2.com/v2/account/bank?access_token="+apiKey).then(addResults)["finally"](RunningRequests.finallyEndRequest);RunningRequests.startRequest();var materialContent=$http.get("https://api.guildwars2.com/v2/account/materials?access_token="+apiKey).then(addResults)["finally"](RunningRequests.finallyEndRequest);promises.push(bankContent),promises.push(materialContent)}else errors.inventories=!0;if(-1!=jQuery.inArray("characters",tokenInfo.permissions)&&-1!=jQuery.inArray("inventories",tokenInfo.permissions)){RunningRequests.startRequest();var charactersBagsPromise=$http.get("https://api.guildwars2.com/v2/characters?access_token="+apiKey)["finally"](RunningRequests.finallyEndRequest).then(function(response){var characters=response.data;return $q.all(jQuery.map(characters,function(character){return RunningRequests.startRequest(),$http.get("https://api.guildwars2.com/v2/characters/"+character+"/inventory?access_token="+apiKey)["finally"](RunningRequests.finallyEndRequest)}))},RunningRequests.failEndRequest).then(function(characterContents){jQuery.each(characterContents,function(i,response){var characterContent=response.data;jQuery.each(characterContent.bags,function(j,characterBag){characterBag&&addResults(characterBag.inventory)})})});promises.push(charactersBagsPromise)}else errors.characters=!0;return $q.all(promises)})["finally"](RunningRequests.finallyEndRequest).then(function(){return{items:idToAmount,errors:errors}})}}}]).service("FullRecipeComputer",["$q","GW2API","RecipeComputer",function($q,GW2API,RecipeComputer){return{getRecipeTree:function(rootItemId,bankContent,buyImmediately){function get(dict,key){return dict[key]||(dict[key]=0),dict[key]}function getRecipe(itemId,unitaryRecipeAmount,remainingNeededAmount){var ownedAmount=Math.min(remainingNeededAmount,get(bankContent,itemId));if(bankContent[itemId]-=ownedAmount,remainingNeededAmount-=ownedAmount,0==remainingNeededAmount)return $q.when({itemId:itemId,unitaryRecipeAmount:unitaryRecipeAmount,remainingNeededAmount:remainingNeededAmount,ownedAmount:ownedAmount,cost:null,ingredients:[]});var recipePromise=RecipeComputer.getRecipe(itemId).then(function(result){return result},function(error){return null}),costPromise=GW2API.getListing(itemId).then(function(result){return result},function(error){return{id:itemId,buys:[],sells:[]}});return $q.all([recipePromise,costPromise]).then(function(results){var recipeResult=results[0],listing=results[1],cost=null;buyImmediately&&listing.sells.length>0?cost=listing.sells[0].unit_price:!buyImmediately&&listing.buys.length>0&&(cost=listing.buys[0].unit_price);var ingredientsPromises;return ingredientsPromises=null!==recipeResult?$q.all(jQuery.map(recipeResult,function(ingredient){var iid=ingredient.id,iamount=ingredient.amount||1,iRemainingNeededAmount=iamount*remainingNeededAmount;return"item"===ingredient.type?getRecipe(parseInt(iid),iamount,iRemainingNeededAmount):$q.when({currencyId:ingredient.id,unitaryRecipeAmount:iamount,remainingNeededAmount:iRemainingNeededAmount,ownedAmount:0,cost:null,ingredients:[]})})):$q.when(null),$q.all([ingredientsPromises,$q.when(cost)])}).then(function(results){var ingredientsResults=results[0],costResult=results[1],ingredientsCost=0;null!==ingredientsResults&&jQuery.each(ingredientsResults,function(i,ingredient){return null===ingredient.cost?(ingredientsCost=null,!1):void(ingredientsCost+=ingredient.cost)});var returnValue={itemId:itemId,unitaryRecipeAmount:unitaryRecipeAmount,remainingNeededAmount:remainingNeededAmount,ownedAmount:ownedAmount,cost:costResult};return null===ingredientsResults||null!==ingredientsCost&&null!==costResult&&ingredientsCost>costResult?returnValue.ingredients=[]:returnValue.ingredients=ingredientsResults,returnValue})}return bankContent=jQuery.extend({},bankContent),getRecipe(rootItemId,1,1)}}}]).directive("item",function(){return{restrict:"E",templateUrl:"item.html",scope:{itemId:"=",amount:"=",buyImmediately:"="},controller:function($scope,RecipeSynthesizer){$scope.$watch("itemId",function(){$scope.itemId&&RecipeSynthesizer.getItem(parseInt($scope.itemId)).then(function(item){$scope.item=item})})}}}).directive("itemTable",["$templateCache","$compile","GW2API",function($templateCache,$compile,GW2API){return{restrict:"E",scope:{itemTree:"=",buyImmediately:"="},link:function(scope,element,attrs){var content=$templateCache.get("item-table-directive.html");scope.open=!1,scope.toggle=function($event){scope.open=!scope.open,$event.preventDefault()},scope.itemTree&&(element.append(content),$compile(element.contents())(scope.$new()))}}}]).directive("convertToBoolean",function(){return{require:"ngModel",link:function(scope,element,attrs,ngModel){ngModel.$parsers.push(function(val){return"true"==val?!0:"false"==val?!1:null}),ngModel.$formatters.push(function(val){return""+val})}}}).directive("costs",["$q","GW2API","RecipeComputer",function($q,GW2API,RecipeComputer){return{restrict:"E",scope:{itemTree:"="},templateUrl:"costs-directive.html",controller:function($scope){function add(dict,key,amount){dict[key]||(dict[key]=0),dict[key]+=amount}function fill(itemTree,itemCosts,currencyCosts,copperCosts){null!==itemTree.cost&!!itemTree.itemId&&(copperCosts[itemTree.itemId]=itemTree.cost);var neededAmount=itemTree.remainingNeededAmount;0!=neededAmount&&(itemTree.ingredients&&0!=itemTree.ingredients.length?jQuery.each(itemTree.ingredients,function(i,ingredient){fill(ingredient,itemCosts,currencyCosts,copperCosts)}):itemTree.itemId?add(itemCosts,itemTree.itemId,neededAmount):add(currencyCosts,itemTree.currencyId,neededAmount))}function splitItems(itemCosts,unbuyableItemCosts,buyableItemCosts,copperCosts){var total=0;return jQuery.each(itemCosts,function(id,amount){void 0!==copperCosts[id]?(buyableItemCosts[id]=itemCosts[id],total+=copperCosts[id]*itemCosts[id]):unbuyableItemCosts[id]=itemCosts[id]}),total}function reload(){var totalCost,itemCosts={},currencyCosts={},copperCosts={},unbuyableItemCosts={},buyableItemCosts={};fill($scope.itemTree,itemCosts,currencyCosts,copperCosts),totalCost=splitItems(itemCosts,unbuyableItemCosts,buyableItemCosts,copperCosts),$scope.totalCost=Math.round(totalCost),$scope.buyableItemCosts=jQuery.isEmptyObject(buyableItemCosts)?null:buyableItemCosts,$scope.unbuyableItemCosts=jQuery.isEmptyObject(unbuyableItemCosts)?null:unbuyableItemCosts,$scope.currencyCosts=jQuery.isEmptyObject(currencyCosts)?null:currencyCosts}$scope.$watch("itemTree",reload,!0)}}}]).controller("ls.Map",["$scope","$q","GW2API","CostComputer","BankService","FullRecipeComputer","RunningRequests",function($scope,$q,GW2API,CostComputer,BankService,FullRecipeComputer,RunningRequests){function reloadTree(){$scope.selectedLegendary&&null!==$scope.buyImmediately&&FullRecipeComputer.getRecipeTree($scope.selectedLegendary,$scope.bankContent||{},$scope.buyImmediately).then(function(data){$scope.costTree=data},function(error){alert("Cost tree error:",error)})}var availableLegendariesIds=CostComputer.legendaryIds;$q.all(jQuery.map(availableLegendariesIds,function(legendaryId){return GW2API.getItem(legendaryId).then(function(legendary){return{name:legendary.name,id:legendary.id}})})).then(function(availableLegendaries){availableLegendaries.sort(function(l1,l2){return l1.name.localeCompare(l2.name)}),$scope.availableLegendaries=availableLegendaries}),$scope.selectedLegendary=null,$scope.buyImmediately=!0,$scope.apiKeyTemp="",$scope.$watch("apiKey",function(){$scope.bankContentErrors=null,$scope.apiKey&&BankService.getFullBankContent($scope.apiKey).then(function(data){$scope.bankContent=data.items,$scope.bankContentErrors=data.errors},function(response){$scope.bankContent={},$scope.bankContentErrors={accessError:response.data.text}})}),$scope.$watch("bankContent",reloadTree),$scope.$watch("selectedLegendary",reloadTree),$scope.$watch("buyImmediately",reloadTree),$scope.$watch(function(){return RunningRequests.get()},function(newValue){$scope.numRunningRequests=newValue})}]);